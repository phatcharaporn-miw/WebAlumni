...
function Home() {
  ...
  const handleReadMore = (newsId) => {
    navigate(`/news/${newsId}`); // เปลี่ยนเส้นทางไปยังหน้ารายละเอียดข่าว
  };
                    ...
                    <div className="card shadow-lg border-0">
                      <div className="row g-0">
                        <div className="col-md-5">
                          <img src="/image/about_cp.jpg" className="img-fluid rounded-start h-100" alt="ภาพสมาคม" />
                        </div>
                        <div className="col-md-7">
                          <div className="card-body">
                            ...
                            <p className="text-secondary"><b>"เชื่อมโยงศิษย์เก่า ก้าวทันเทคโนโลยี สนับสนุนสังคมดิจิทัล"</b></p>
