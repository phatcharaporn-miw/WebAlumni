...
function AlumniProfileDonation() {
    ...
    //         const res = await fetch(`http://localhost:3001/donate/check-payment-donate/reslip/${selectedDonation.donation_id}`, {
    //             method: "PUT",
    //             body: formData,
    //         });
    ...
    //         if (res.ok) {
    //             // อัปเดต UI: แทนที่ slip ใหม่ และเปลี่ยนสถานะเป็น pending
    ...
    //             // อัปเดต list หลักด้วย (ไม่ต้องรีเฟรชทั้งหน้า)
    //             setDonations((prev) =>
    //                 prev.map((d) =>
    //                     d.donation_id === selectedDonation.donation_id
    //                         ? { ...d, slip: data.newSlip, payment_status: "pending", reject_reason: null }
    //                         : d
    //                 )
    //             );

    //             alert("อัปโหลดสลิปใหม่เรียบร้อย รอการตรวจสอบ");
    //         } else {
    ...
    const getStatusStyle = (status) => {
        switch (status) {
            case "paid":
                return (
                    <span className="badge rounded-pill fs-6 px-3 py-2 text-success bg-success bg-opacity-10">
                        ชำระเงินแล้ว
                    </span>
                );
            case "pending":
                return (
                    <span className="badge rounded-pill fs-6 px-3 py-2 text-warning bg-warning bg-opacity-10">
                        รอดำเนินการ
                    </span>
                );
            case "failed":
            case "rejected":
                return (
                    <span className="badge rounded-pill fs-6 px-3 py-2 text-danger bg-danger bg-opacity-10">
                        ล้มเหลว/ถูกปฏิเสธ
                    </span>
                );
            default:
                return (
                    <span className="badge rounded-pill fs-6 px-3 py-2 bg-secondary text-white">
                        ไม่ทราบสถานะ
                    </span>
                );
        }
                                ...
                                <div className="row w-100 g-3 align-items-center">
                                    ...
                                    <div className="col-md-4 col-12">
                                        <div className="d-flex align-items-center justify-content-between">
                                            <label className="form-label mb-0 me-2">สถานะ:</label>
                                            <select
                                    ...
                                    <div className="col-md-4 col-12">
                                        <div className="d-flex align-items-center justify-content-between">
                                            <label className="form-label mb-0 me-2">ปี:</label>
                                            <select
                                                className="form-select form-select-sm"
                                                value={filterYear}
                                    ...
                                    <div className="col-md-4 col-12">
                                        <div className="d-flex align-items-center justify-content-between">
                                            <label className="form-label mb-0 me-2">ลำดับ:</label>
                                            <select
                                                className="form-select form-select-sm"
                                                value={sortOrder}
