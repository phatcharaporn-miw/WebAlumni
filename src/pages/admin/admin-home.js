...
function AdminHome() {
    ...
    return (
        <div className="container mt-4">
            <h3 className="mb-4">กิจกรรมและการเข้าร่วม</h3>
                ...
                <>
                    <div className="d-flex justify-content-between mb-3">
                        ...
                        <div className="btn-group">
                            ...
                            >
                                <FaCheck className="me-1" /> สิ้นสุดแล้ว
                            </button>
                        </div>
                                ...
                                {filteredActivities.length > 0 ? (
                                    filteredActivities.map((act) => (
                                        <tr key={act.activity_id}>
                                            ...
                                            <td>
                                                {act.status === 0 ? (
                                                    <span className="badge bg-warning text-dark">ยังไม่เริ่ม</span>
                                                ) : act.status === 1 ? (
                                                    <span className="badge bg-secondary">สิ้นสุดแล้ว</span>
                                                ) : (
                                                    <span className="badge bg-success">กำลังดำเนินการ</span>
                                                )}
                                            </td>
                                            <td>
