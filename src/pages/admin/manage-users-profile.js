              ...
              <div className="text-center">
                <div className="position-relative d-inline-block mb-3">
                  ...
                  <div className="position-absolute bottom-0 end-0">
                    <span className={`badge ${user.is_active ? 'bg-success' : 'bg-seco'} border border-2 border-white`}>
                      <i className={`fas fa-circle me-1`}></i>
                      {user.is_active ? 'ใช้งาน' : 'ระงับ'}
                    </span>
                  </div>
                </div>
                <h3 className="mb-2 fw-bold">{user.full_name || "ไม่ระบุชื่อ"}</h3>
                          ...
                          <div className="card-body p-4">
                            <div className="d-flex align-items-start gap-3">
                              ...
                              <div className="flex-grow-1">
                                ...
                                <span className={`badge px-3 py-2 rounded-pill ${act.status === 1 ? "bg-success bg-opacity-10 text-success" :
