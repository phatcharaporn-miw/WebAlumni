                            ...
                            <div className='bg-white rounded-4 shadow-sm text-center p-4'>
                                ...
                                <div className='menu d-block mt-3 w-100'>
                                    {[
                                        ...
                                        ['ประวัติการสั่งซื้อของที่ระลึก', '/student-profile/student-profile-souvenir'],
                                    ].map(([label, path], i) => (
                                ...
                                {filteredDonations.length > 0 ? (
                                    ...
                                    <div className="text-center py-5">
                                        <div className="empty-state">
                                            <div className="mb-4">
                                                <h5 className="text-muted">ยังไม่มีประวัติการบริจาค</h5>
                                                <p className="text-muted mb-4">เมื่อคุณทำการบริจาค ประวัติจะแสดงที่นี่</p>
                                            </div>
                                        </div>
                                    </div>
                                )}
...
export default StudentProfileDonation;