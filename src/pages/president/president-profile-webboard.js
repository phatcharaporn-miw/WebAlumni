...
function PresidentProfileWebboard() {
    ...
    const handleEdit = (webboardId) => {
        navigate(`/president-profile/president-profile-webboard/president-edit-webboard/${webboardId}`);
    };
                    ...
                    <div className="col-12 col-lg-3 col-md-4 mb-4">
                        <div className="bg-white rounded-4 shadow-sm text-center p-4">
                            ...
                            <div className="menu d-block mt-3 w-100">
                                ...
                                <div className="menu-item py-2 mb-2 rounded" onClick={() => handleClick("/president-profile/president-summary-all")}>ภาพรวมข้อมูลทั้งหมด</div>                                <div className="menu-item active py-2 mb-2 rounded" onClick={() => handleClick("/president-profile/president-profile-webboard")}>กระทู้ที่สร้าง</div>
...
export default PresidentProfileWebboard;