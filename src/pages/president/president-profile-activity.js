            ...
            <div className="row justify-content-between ">
              <div className="col-12 col-md-4 bg-light rounded text-center p-4 my-4">
                ...
                <div className="menu">
                  ...
                  <div className="menu-item py-2 mb-2 rounded" onClick={() => handleClick('/president-profile/donation-history')}>
                    ประวัติการบริจาค
                  </div>
                  <div className="menu-item active py-2 mb-2 rounded" onClick={() => handleClick('/president-profile/president-profile-activity')}>
