    ...
    const handleSubmit = async (e) => {
        ...
        if (!userId) {
            Swal.fire({
                ...
                text: 'กรุณาเข้าสู่ระบบก่อนดำเนินการบริจาค',
        ...
        if (startDate && now < startDate) {
            Swal.fire({
                icon: 'info',
                title: 'โครงการยังไม่เริ่ม',
                text: `โครงการนี้จะเริ่มในวันที่ ${formatDate(startDate)}`,
        ...
        if (endDate && now > endDate) {
            Swal.fire({
                icon: 'error',
                title: 'โครงการสิ้นสุดแล้ว',
                text: `โครงการนี้สิ้นสุดเมื่อวันที่ ${formatDate(endDate)}`,
                confirmButtonText: 'ตกลง'
            });
            return;
        }
                        ...
                        <button
                            ...
                            onClick={() => {
                                Swal.fire({
                                    ...
                                    text: "คุณต้องการยกเลิกการบริจาคนี้หรือไม่?",
                                    icon: 'warning',
